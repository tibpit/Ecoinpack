/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: e237e588d8489027dda981783afc1ecd)
// Runtime types generated with workerd@1.20260609.1 2026-06-01 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	REDPEN_KV: KVNamespace;
	ASSETS: Fetcher;
	NEXT_PUBLIC_APP_URL: "http://localhost:3000";
	RESEND_FROM_EMAIL: "RedPen Profile <results@yourdomain.com>";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_APP_URL" | "RESEND_FROM_EMAIL">> {}
}
